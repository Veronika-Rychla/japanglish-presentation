    ...
    <section>
      <div className="canva bubble" id="canva">
        ...
        <p>
          ...
          interactivity! The level of interactivity varies. While some games
          have very complicated decision-making designs and even one wrong
          answer might mean not getting the outcome you want, there are also
        ...
        <p>
          ...
          years ever since role-playing games started back in 1980s. However,
          the main difference is that a visual novel is much closer to reading a
        ...
        <p>
          ...
          novels are a hybrid medium and as such, they can be enjoyed by both
          bookworms and gamers. Try one as well! Maybe ours?
        </p>
      </div>
    </section>
  );
